    ...
    FormValidator.prototype = {
        ...
        mark : function( field, text ){
            ...
            if( this.settings.alerts ){   
                ...
                warning = '<div style="word-wrap: break-word;" class="'+ this.settings.classes.alert +'">';
                warning += '<ul>';
                for( var i=0; i < mensajes_error.length; i++ ){
                	 warning += '<li>'+mensajes_error[i]+'</li>';
                }
                warning += '</ul>';
                warning += '</div>';
        ...
        */
        ...
        prepareFieldData : function( field ){
            ...
            this.data[id].message 		 = field.getAttribute('data-message') ? field.getAttribute('data-message') : false;
...
//                return { valid:true, error:"" }
            ...
            */
            ...
            //testResult[0] = this.tests.hasValue.call(this, data.value);
